        ...
        >
            <div
                style={{
                    ...
                    overflow: 'hidden',
                    boxShadow: isHovered
                        ? '0 25px 50px rgba(99, 102, 241, 0.4), 0 0 80px rgba(139, 92, 246, 0.2)'
            ...
            >
                ...
                <div style={{ position: 'relative', width: '100%', height: '280px', overflow: 'hidden' }}>
                    ...
                    <div style={{
                        ...
                        <span style={{ fontSize: '12px', color: '#22c55e', fontWeight: 500 }}>Available</span>
                    </div>
                </div>
                ...
                <div style={{ padding: '20px 24px 24px' }}>
                    ...
                    <div style={{
                        ...
                        <p style={{ fontSize: '13px', color: 'rgba(199,210,254,0.9)', lineHeight: 1.5 }}>
                            {status}
                        </p>
                    </div>
