...
export const Component = () => {
  ...
  useEffect(() => {
    ...
    const createMountains = () => {
      ...
      layers.forEach((layer, index) => {
        ...
        (mountain as any).userData = { baseZ: layer.distance, index };
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      refs.mountains.forEach((mountain, i) => {
        const speed = 1 + i * 0.9;
        const targetZ = (mountain as any).userData.baseZ + scrollY * speed * 0.5;
        (mountain as any).userData.targetZ = targetZ;
    ...
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div className="scroll-sections">
        {[...Array(2)].map((_, i) => {
          ...
          const subtitles: {
            [key: number]: { line1: string; line2: string };
          } = {
            0: {
